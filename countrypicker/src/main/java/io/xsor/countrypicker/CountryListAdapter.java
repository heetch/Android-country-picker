...
public class CountryListAdapter extends RecyclerView.Adapter<CountryListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder item, int position) {
        ...
        String itemText = new Locale(Locale.getDefault().getLanguage(), country.getIsoCode()).getDisplayCountry();


        if(showDialingCode) {
            itemText += String.format(c.getString(R.string.format_dialing_code), country.getDialingCode());
        }

        item.name.setText(itemText);

        int flagResId = CountryPickerUtils.getMipmapResId(c, country.getIsoCode().toLowerCase(Locale.ENGLISH) + "_flag");
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            adapter.mCallback.onCountrySelected(country, CountryPickerUtils.getMipmapResId(view.getContext(),
